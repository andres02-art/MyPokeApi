...
<body>
        ...
        <form action="" id="LogView">
            <div class="LogViewForm">
                <div class="LogViewRegister ListRegFlow">
                    ...
                    <input class="ContentCenter" type="text" name="fristName" placeholder="segundo nombre" id="fristName">
                    ...
                    <input class="ContentRigth" type="number" minlength="1" maxlength="10"  name="__credentials" placeholder="Cedula" id="Credential">
                    <p class="ContentLeft">Confirmar cc:</p>
                    <input type="number" minlength="1" maxlength="10" name="__Ccredentials" id="CCredential" placeholder="Confirmar cedula" max="10" class="ContentRigth">
                    ...
                    <input type="email" name="__address" id="Address" placeholder="Correo" class="ContentRigth">
                    <p class="ContentLeft">Contraseña:</p>
                    <input type="password" name="_password" id="password" placeholder="contraseña" class="ContentRigth">
                    <p class="ContentCenter">Confirmar contraseña:</p>
                    <input type="password" name="_Cpassword" id="Cpassword" placeholder="Confirmar contraseña" class="ContentCenter">
                    <hr class="ContentCenter">
                    <input class="ContentCenter" value="Registrarse" type="button" name="Registrarse" />
                </div>
                <div class="LogViewIn ListRegFlow">
                    ...
                    <hr class="ContentCenter">
                    <input class="ContentCenter"value="Iniciar Sesion" type="button" id="LogInUser" name="LogIn" /> 
                </div>
                <div class="LogViewRecovery ListRegFlow">
                    ...
                    <input class="ContentCenter" value="Recuperar Cuenta" type="button" id="RecoveryUser">
                </div>
                <div class="LogViewSearch ListRegFlow">
                    <label class="ContentLeft" for="Search">Buscar</label>
                    <input class="ContentRigth" type="search" placeholder="Buscar Pokemon" id="PokeSeart" name="__pokemon">
                    <input class="ContentMid" value="Buscar" type="button" myled="LogView" name=""id="SearchPokemon"/> 
    ...
    <section class="BasicView">
        <form action="" class="BasicViewForm">
            <div class="BasicViewBody">
                <img id="background" src="./Assets/Img/pngs/MyPokeApi.png" width="90%" height="100%" alt="imagen echa con figma">
            </div>
    ...
    <section class="PopupView">
        <form action="">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tenetur ad non quisquam quo, cumque dolore minus dolorum dolores hic, voluptatem eligendi praesentium saepe nemo sed sit explicabo pariatur excepturi ex?</p>
        ...
        <div class="PokemonContentView">
            ...
            <div class="PokemonBody ListReg">
                    ...
                    <div class="PokemonDescription">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae incidunt impedit porro, tempore asperiores minima voluptatem. Sit quis debitis deleniti, odio nostrum aperiam pariatur quasi dolore nam, sapiente provident qui!</p>
                    </div>
            </div>
